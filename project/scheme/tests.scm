...
(contains? '(1 3 5 7 9) 7)
;expect True

(contains? '(1 3 5 7 9) 2)
;expect False
...
(union '(1 2 3 4 5) '(1 3 5 6 8))
;expect (1 2 3 4 5 6 8)
...
(sub-all '(1 2 3 4) '(2 4) '('hello 'hi))
;expect (1 (quote hello) 3 (quote hi))
